...
##predict_match('Sunderland','Chelsea')
...
#print(standings_dataframe[standings_dataframe['Team'] == 'Crystal Palace'].index.values.astype(int)[0])
# dataframe.ix[2,'W'] = 10 #updating
# print(dataframe.at[2,'W']) #reading

standings_dataframe = standings_dataframe.sort_values(['P','GD'], ascending=False)
standings_dataframe = standings_dataframe[['Team','W','D','L','GF','GA','GD','P']]
print(standings_dataframe)